...
function DriverBasicInfo() {
  ...
  const updateCheckr = (checkr) => {
    const driverId = location.pathname.split("/")[3];
   sendRequest(`admin/user/update-checkr/${driverId}`, "PUT", { checkr: checkr }, updateCheckrResponse);
 }
                ...
                <div className="col-lg-4 col-sm-12 ">
                  ...
                  <div className="col-sm-4 col-lg-4">
                    ...
                    <div className="col-lg-2"></div>
                     ...
                     <div className="col-sm-6 col-lg-6" style={{fontSize:9}}>{driver.email}</div>
                  </div>
                  <div className="row">
                  <div className=" col-lg-2"></div>
                     <div className="col-sm-4 col-lg-4"><b>Contact:</b></div>
                     <div className="col-sm-5 col-lg-6"style={{fontSize:9}}>{driver.phone_no}</div>
                  </div>
                  <div className="row">
                  <div className="col-lg-2"></div>
                     <div className="col-sm-4"><b>Checkr:</b></div>
                     <div className="col-sm-5"> 
                     { driver.checkr_status?
                     <i class="batch-icon batch-icon-tick"></i>:
                     <i class="batch-icon batch-icon-cross"></i>}</div>
                  </div>
                  <div className="row">
                  <div className="col-lg-2"></div>
                     <div className="col-sm-4"><b>Status:</b></div>
                    <div className="col-sm-5">
                  ...
                  <div className="col-lg-6 ">
                    <div className="statusIcon"> <i className="batch-icon batch-icon-user-alt-3"></i> Available </div>
                ...
                <div className="col-sm-3">
                  ...
                  <div className="col-sm-9 license-details">
                    ...
                    <div className="col-sm-2"></div>
                       <div className="col-sm-6"> <b>License State: </b></div>
                       <div className="col-sm-4">{vehicle.license_state} </div>
                    </div>
                    <div className="row">
                    <div className="col-sm-2"></div>
                       <div className="col-sm-6"> <b>License Number: </b></div>
                       <div className="col-sm-4">{vehicle.license_number} </div>
                    </div>
                    <div className="row">
                    <div className="col-sm-2"></div>
                       <div className="col-sm-6"> <b>License Expiry Date: </b></div>
                       <div className="col-sm-4">{ formatDate(vehicle.license_expiry_date)} </div>
                    </div>
                ...
                <div className="col-sm-3">
                  ...
                  <div className="col-sm-9 license-details">
                    <div className="row">
                        ...
                        <div className="col-sm-3"> <b>Vehicle Type:</b></div>
                        <div className="col-sm-3">{vehicle.vehicle.vehicle_type}</div>
                        <div className="col-sm-3"> <b> Insurance Number: </b></div>
                        <div className="col-sm-3">{vehicle.vehicle.insurance_number} </div>
                  </div>
                  <div className="row">
                        <div className="col-sm-3"> <b>Insurance Expiry Date:</b></div>
                        <div className="col-sm-3">{ formatDate(vehicle.license_expiry_date)}</div>
                        <div className="col-sm-3"> <b>Vehicle Make</b></div>
                        <div className="col-sm-3">{vehicle.vehicle.vehicle_make} </div>
                  </div>
                  <div className="row">
                        <div className="col-sm-3"> <b>Vehicle Color: </b></div>
                        <div className="col-sm-3">{vehicle.vehicle.vehicle_color} </div>
                        <div className="col-sm-3"> <b>Vehicle Number</b></div>
                        <div className="col-sm-3">{vehicle.vehicle.vehicle_number} </div>
                    </div>
