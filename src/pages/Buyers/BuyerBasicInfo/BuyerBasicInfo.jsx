...
function BuyerBasicInfo() {
  ...
  const updateStatus = (status) => {
     const buyerId = location.pathname.split("/")[3];
    sendRequest(`admin/user/update-status/${buyerId}`, "PUT", { status: status }, updateStatusResponse);
  }
             ...
             <div className="row personal-info">
                ...
                <div className="col-lg-6 col-sm-8 col-md-5">
                  ...
                  <div className="col-sm-6 col-lg-3">
                    ...
                    <div className="row">
                     <div className="col-sm-3 col-lg-3"><b>Email:</b></div>
                     <div className="col-sm-9 col-lg-9">{buyer.email}</div>
                  </div>
                  <div className="row">
                     <div className="col-sm-4 col-lg-3"><b>Contact:</b></div>
                     <div className="col-sm-8 col-lg-9">{buyer.phone_no!=='+undefined'?buyer.phone_no:'NA'}
                    {console.log(buyer.phone_no)}
                    </div>
                  </div>
                  <div className="row">
                     <div className="col-sm-4 col-lg-3"><b>Checkr:</b></div>
                     <div className="col-sm-8 col-lg-9"><i class="batch-icon batch-icon-tick"></i></div>
                  </div>
                  <div className="row">
                     <div className="col-sm-4 col-lg-3"><b>Status:</b></div>
                    <div className="col-sm-8 col-lg-9">
                      {!status?<span>{buyer.status === "active" && (
